...
- [Exercise 3 - Test the integration scenario](exercises/ex3/)
    ...
    - [Check the Cloud Integration monitoring](exercises/ex3/ex32)
    - [Check your Email inbox](exercises/ex3/ex33)
    - [Approve the new hire in SAP Process Automation](exercises/ex3/ex34)
