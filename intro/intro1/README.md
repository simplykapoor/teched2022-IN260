...
This session scenario helps you to learn event-driven integration pattern along with the exactly-once quality of service using SAP Integration Suite and Confluent Kafka.
...
2. You also like to initiate the newly hired candidate's equipment and training approval workflow to the manager using the SAP Process Automation.
