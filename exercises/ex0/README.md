...
2. In some cases, you may get the following questionnaire screen. If not, proceed to exercise step **4**. Otherwise, select link *Skip* from the upper right of the screen
